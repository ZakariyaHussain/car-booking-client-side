        ...
        userGoogleLogin()
            ...
            .catch(error => {
                ...
                Swal.fire({
                    icon: "error",
                    title: "Oops...",
                    text: "Wrong email or password! Try again later",
                    timer: 2500
                });
                return (error.message);
            })
    ...
    return (
        <div className="card bg-base-100 w-full max-w-sm mx-auto my-16 shrink-0 shadow-2xl">
            ...
            <div className="card-body">
                ...
                <p>Are you a new user? Please <Link className='text-blue-500 text-xl underline' to='/register'> Register </Link> now</p>
            </div>
            {/* Google */}
